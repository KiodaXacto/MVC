    ...
    <div class="container">
        <div class="row align-items-center min-vh-75 min-vh-lg-100">
            <div class="col-md-7 col-lg-6 col-xxl-5 py-6 text-sm-start text-center"  style="z-index: 2;">
                <h1 class="mt-6 mb-sm-4 fw-semi-bold lh-sm fs-4 fs-lg-5 fs-xl-6">Accueil</h1>
                <p class="mb-4 fs-1">Bienvenue Dans votre site APPR ...</p><a class="btn btn-lg btn-success" href="#events"
                    role="button">Découvrir nos Actioins ..!</a>
            </div>
        </div>
    </div>
</section>